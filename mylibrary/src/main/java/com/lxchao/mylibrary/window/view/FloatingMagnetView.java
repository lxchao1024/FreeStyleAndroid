...
import com.lxchao.mylibrary.window.utils.SystemUtils;
...
public class FloatingMagnetView extends FrameLayout {
    ...
    private void init() {
        ...
        mStatusBarHeight = SystemUtils.INSTANCE.getStatusBarHeight(getContext());
        setClickable(true);
        updateSize();
    }
    ...
    protected void updateSize() {
        mScreenWidth = (SystemUtils.INSTANCE.getScreenHeight(getContext()) - this.getWidth());
        mScreenHeight = SystemUtils.INSTANCE.getScreenHeight(getContext());
    }
